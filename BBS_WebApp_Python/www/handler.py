...
from BBS_WebApp_Python.www.ormmodel import User, Blog, next_id
from BBS_WebApp_Python.www.apis import APIValueError, APIError
...
async def authenticate(*, email, password):
    ...
    if user.password != sha1.hexdigest():
        raise APIValueError('password', 'Invalid password.')
    # authenticate success,set cookie
    r = web.Response()
