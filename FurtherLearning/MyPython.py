...
class TouTiaoSpider(object):
    ...
    def __getNewsContent(self):
        self.__getHTMLContent(
            'https://www.toutiao.com/api/pc/feed/?max_behot_time=1527746296&category=__all__&utm_source=toutiao&widen=1&tadrequire=true&as=A1850B509FEA153&cp=5B0FCA7105731E1&_signature=-2kA6RAXoHBEH.EPZ20y2vtpAP')
